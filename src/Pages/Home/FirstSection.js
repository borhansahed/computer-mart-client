        ...
        <>
            <div className='lg:flex justify-center items-center gap-10 mt-12 lg:mt-32   lg:px-0'>
                <div className='mb-10 px-20 lg:mb-0 lg:px-0'>
                   <h1 className=' text-3xl lg:text-5xl mb-3'>Experience with <br />Macbook <span className='text-yellow-300'>Pro</span></h1>
                  ...
                  <Link to="/purchase"><button   className='btn btn-outline btn-black  lg:btn lg:btn-outline  btn-sm '>Shop Now</button></Link>
                  <Link to="/purchase"><button className='btn btn-outline btn-warning btn-sm lg:btn lg:btn-outline  ml-10'>See It All</button></Link>
