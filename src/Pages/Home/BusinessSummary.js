...
const BusinessSummary = () => {
    return (
        ...
        <div className='lg:mb-20 mb-16'>
           ...
           <div className='flex flex-wrap items-center gap-x-24 gap-y-14 justify-center mt-10  lg:flex lg:flex-row lg:justify-center lg:items-center lg:gap-44 lg:mt-20' >
               ...
               <div>
               <AiOutlineFundProjectionScreen className='text-2xl ml-10 mb-3 lg:text-4xl lg:mb-6 lg:ml-10'/>
                   <p className='font-bold text-3xl ml-9 lg:text-5xl text-bold lg:ml-9'>   <CountUp  end={535} duration="5" /><span className='text-2xl lg:text-4xl'>+</span></p>
                   <p className='text-xl lg:text-2xl text-yellow-500'>Compelete Projects</p>
                 

               </div>
               <div>
               <GrGroup className='text-2xl ml-7 mb-3 lg:text-4xl lg:mb-6 lg:ml-5'/>
               <p className='font-bold text-3xl ml-6 lg:text-5xl lg:ml-4'>   <CountUp  end={273} duration="5" /><span className=' text-2xl lg:text-4xl'>+</span></p>
               <p className=' text-xl lg:text-2xl text-yellow-500'>Happy Clients</p>
               </div>
               ...
               <p className=' text-xl lg:text-2xl text-yellow-500'>Feedback</p>
               </div>
