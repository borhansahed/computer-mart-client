...
const Footer = () => {
    return (
        <div style={{backgroundImage: `url(${logo})`}} className='footer-section mt-20 text-white   '>
           <div>
           ...
           <div className='mt-20   lg:flex lg:gap-36  lg:justify-center lg:items-center '>
               <div>
                 <h3 className='text-2xl lg:text-3xl mb-1 lg:mb-3 '>Computer <HiDesktopComputer className='inline mr-2 text-xl'/></h3>
                 <p className='text-base lg:text-xl text-justify'>This is Computer Mart Choose your Product <br />
                 And stay with us 
           ...
           <p className='text-center  mt-7'>Copyright  2000-2022  by  <a href='#' className='text-yellow-400'>Computer Mart</a>  .  All Rights Reserved.</p>
        </div>
    );
};
