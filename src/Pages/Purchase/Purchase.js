...
const Purchase = () => {
  ...
  const handleOrder = (event) => {
    ...
    if (MinimumOrderQuantity > quantity) {
      return toast.error(
        "Pls select your quantity minimunOrderQuantity or above"
      );
    }
        ...
        <div className="products-container flex flex-col lg:flex-row lg:gap-x-20 gap-y-7">
          <div className="card w-72  products-cards lg:w-96 bg-base-100">
            ...
            <div className="card-body">
              ...
              <p className=" text-base lg:text-2xl mb-0 ">
                {" "}
                <span className="">AvailableQuantity : </span>
                {AvailableQuantity}
              </p>
              <p className=" text-base lg:text-2xl mb-0 mt-0">
                {" "}
                <span className="">MinimumOrderQuantity : </span>
                {MinimumOrderQuantity}
              </p>
              <p className=" text-2xl lg:text-4xl font-bold  mt-0 mt-2 lg:mt-0">
                {" "}
                <span className="">$</span>
                {price}
              </p>
            ...
            <form onSubmit={handleOrder} className="w-72">
              <div className="form-control ">
                ...
                <input
                  ...
                  disabled
                  {...register("your name", { required: true, maxLength: 10 })}
                  autoFocus=""
                />
              </div>
              ...
              <div className="form-control ">
                ...
                <input
                  ...
                  disabled
                  placeholder="Name"
                  {...register("equipment", { required: true, maxLength: 10 })}
                />
              </div>
              <div className="form-control">
                <label className="label">
              ...
              <div className="form-control mt-6">
                <input
                  className=" text-white lg:text-white  btn  btn-warning btn-sm lg:btn lg:btn-warning  lg:text-xl   w-full mt-2 lg:mt-0"
                  type="submit"
                  value="ORDER"
                />
              </div>
