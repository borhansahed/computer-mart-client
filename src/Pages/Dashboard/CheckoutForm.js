  ...
  return (
    <>
      <form onSubmit={handleSubmit}>
        ...
        {!booking.paid ? (
          <button
            className="btn btn-sm text-base font-medium  mt-4  btn-outline btn-warning"
            type="submit"
          ...
          <button className="btn  btn-sm btn-success text-base mt-4 font-medium text-white">
            Paid
          </button>
        )}
        ...
        {success && (
          <p className="text-green-600 text-xl">
            Your transaction id :{" "}
            <span className="text-yellow-400">{transaction}</span>{" "}
          </p>
        )}
      </form>
    </>
