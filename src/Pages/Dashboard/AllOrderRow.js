...
const AllOrderRow = ({booking , index , isLoading}) => {
    ...
    return (
        <tr className='text-xl'>
              ...
              {booking.paid ? <button className='text-base  btn-sm  btn btn-outline btn-warning ml-3'>Shipping</button> : <button className='text-base  btn-sm  btn btn-outline btn-error ml-3'>Cancel</button> }
              </td>
