...
const ManageAllOrders = () => {
  const {
    ...
    fetch("https://computer-mart2.onrender.com/bookings", {
      method: "GET",
      headers: {
  ...
  return (
    <div>
      <h4 className=" text-2xl lg:text-3xl mt-3 mb-3 text-yellow-400  ml-16 lg:ml-0">
        All Orders{" "}
      </h4>
      ...
      <div className="w-screen lg:w-full  overflow-x-auto">
        <table className="table w-screen lg:w-full">
          <thead>
            <tr>
              <th></th>
              <th className="text-base font-medium lg:text-xl  text-yellow-500">
                Email
              </th>
              <th className="text-base font-medium lg:text-xl  text-yellow-500">
                Product
